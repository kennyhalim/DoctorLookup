export class Doctor {
  ...
  getDoctorBySpecialty(specialty) {
    return new Promise(function(resolve, reject) {
      let request = new XMLHttpRequest();
      let url = `https://api.betterdoctor.com/2016-03-01/doctors?specialty_uid=${condition}&location=47.608013%2C%20-122.335167%2C100&user_location=47.608013%2C%20-122.335167&skip=0&limit=10&user_key=0ac855b6f31857a09146df3ee3cc317d`;
      request.onload = function() {
        if (this.status === 200) {
          resolve(request.response);
        } else {
